 ...
 * QUI		QUAND		QUOI
 * -------	-----------	--------------------------------------------------------------------------------------------------------------------------------------
 * pamoire	26.01.2018	Correction maximize dans le cas ou l'écran parent contient un ascenseur. (tester EI11 & Chrome 63)
 *
 */
...
(function() {
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    maximize: function() {
      ...
      ----------------------------------------------------- */
	  newHeight = (window.innerHeight==undefined ? document.documentElement.clientHeight /* IE8 */ : window.innerHeight /* Chrome */); 
	  newWidth  = (window.innerWidth==undefined ? document.documentElement.clientWidth /* IE8 */ : window.innerWidth /* Chrome */);
	  
	  var savWidth = newWidth;
	  if (document.documentElement.scrollHeight>newHeight) newWidth  = newWidth  - 15;
	  if (document.documentElement.scrollWidth>savWidth)   newHeight = newHeight - 15; 
	  
	  newWidth -= 10; // prend en compte la bordure...
